(function($) {
    ...
    */
    ...
    var d3Chart = $('.d3-chart'),
        d3PlaceholderParams = d3Chart.attr("data-params"),
        d3Params = $.parseJSON(d3PlaceholderParams);
    ...
    $('div.d3-chart').each( function(index, element) {
        ...
        */
        ...
        if(placeholderTag.tagName === 'TABLE') {
            ...
            */
            ...
            var columnName = params[index]["column_name"],
                ...
                multipleColumns = params[index]["multiple_columns"];
                
                chartDataStore[index] = [];

            d3.text(placeholderTag.attributes.href.nodeValue).get(function(e, r, i) {
        ...
        function buildRadioArray() {
            /**
            * Build Radio array
            */
            var columnName = params[index]["column_name"];
            // console.log(chartDataStore[index]['category'].indexOf(columnName));
            ...
            */
            $('.chart-radio-filters').each(function(index, element) {
                $(this).find(':radio').change(function() {
                    ...
                    var i = this.attributes['data-index'].nodeValue;
                    var newChartData = manipulateOptionData(chartRef, i);
        ...
        function buildCheckBoxArray() {
            ...
            */
            ...
            $(".chart-checkbox").html("<p><strong>Select a province and/or territory</strong></p>");
            ...
            * Filter charts based on checkbox interaction
            */
            $('.chart-checkbox-filters').each( function(index, element) {
        ...
        * Helper function to manipulate chart data with checkbox input
        */
         function manipulateOptionData(chartRef, index) {
            var chartDataHeader = chartDataStore[chartRef]['header'].slice(0);
            var chartDataRow = chartDataStore[chartRef]['data'][index].slice(0);
    ...
    */
    function getTableData(scope, params, placeholderName) {
        ...
        /**
     * Helpers to know if we hare using multiple filters or only one
     * @todo If using multiple, give th epossibible to add the remaining filter anywhere else
     * 
     */
    function getFiltersData(params) { 
        var multipleFiltersData = params['multiple_filters'];

        if (multipleFiltersData == undefined || multipleFiltersData == 'false') {
            return 0;
        } else if (multipleFiltersData == 'true') {
            return 1;
        }
    }
